	...
	var _tripId,
		...
		_nodeTmpl = ['<li class="row-fluid trip-node" data-id="{{id}}">', 
						...
						'<span class="span10">',
							...
							'<span class="trip-node-duration trip-node-detail">{{duration}}</span>',
							' - ',
							'<span class="trip-node-date">',
								'{{#has_starts_on}}<span class="trip-node-date-date trip-node-detail">{{starts_on_formatted}}</span>{{/has_starts_on}}',
